...
function ProductDetails() {
    ...
    // const addtoCartDB = 
    // console.log("addtoCartDB==>",addtoCartDB);
    ...
    const addtoCart = async () => {
        try {
            ...
            const docRef = await addDoc(cartCollection, cartIntoDb);
    ...
    // const handleAddMore = () => {
    //     setQuantity(quantity + 1); // Increase quantity on "Add More" click
    // };
    ...
    return (
        <div>
                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4">
                                ...
                                <span className="flex ml-3 pl-3 py-2 border-l-2 border-black-500 space-x-2s">
            ...
            <div className="flex justify-center  border -m-4">
                {/* {
                    isLoading ? (
                        <p>Loading </p>
                    ) : (
